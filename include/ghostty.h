...
typedef enum {
  GHOSTTY_EQUALIZE_SPLITS_ALL,
  GHOSTTY_EQUALIZE_SPLITS_COLUMNS,
  GHOSTTY_EQUALIZE_SPLITS_ROWS,
} ghostty_action_equalize_splits_e;
...
typedef union {
  ...
  ghostty_action_equalize_splits_e equalize_splits;
